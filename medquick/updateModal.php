  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-edit"></i> UPDATE Medicines INFORMATION</h4>
      </div>
...
<div class="col-lg-2">
  ...
  <div class="row">
  <div class="col-lg-2">
    <label class="pull-right">Quantity*</label></div>
    <div class="col-lg-10">
   
      <input type="number" class="form-control" id="qty" name="qty" placeholder="<?php echo $qty;?>" value="<?php echo $qty;?>" required>
  </div></div><br>
...
//
				...
				$sql = ("UPDATE tblcnp set name = '$name',
													   ...
													   prize = '$prize',
													   image = '$location',
                             quantity = '$qty' WHERE id = '$id'") or die (mysqli_error());
