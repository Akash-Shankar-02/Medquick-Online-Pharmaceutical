...
if(isset($_POST['savechanges'])){
    ...
    $sqll=("SELECT quantity FROM tblcnp WHERE id='$id'") or die(mysqli_error());
    $res=mysqli_query($con,$sqll);
        ...
        $result=mysqli_query($con, $sql);
                      ...
                      $sqlll=("UPDATE tblcnp set quantity='$edit' where id='$id'") or die (mysqli_error());
...
{
  echo '<script>alert("Please select quantity smaller than or equal to the available quantity");
											 window.location.href="availableframe.php"</script>';
}	}}
?>
