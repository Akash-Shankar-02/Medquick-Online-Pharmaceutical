...
<section id="tour-packages" class="center wow fadeInDown">
    <div style="font-size:30px; font-family:verdana; font-weight:bold; color: #8B8B00; text-align:center;">Medicines Available</div>
        <p style="text-align:center; font-family:verdana;"><br></p>

        <div class="container" style="height:580px;">
			<iframe src="availableframe.php" width="100%;" height="580px;" style="border-style:none;"></iframe>
