            ...
            <div class="col-md-12" style="background-color:#fff; border: solid #D9D9D9 1px; padding: 10px; padding-top: 5px; box-shadow: #9F9F9F 2px 3px 5px; margin-top: 10px; height: 100%">
              ...
              <table class="table table-responsive table-hover table-bordered table-condensed table-striped wow fadeInDown" width="100%">
              	<thead>
                	<tr style="background-color:#000; color:#FFF;">
                        ...
                        <td style="text-align:center; width:auto;" class="wow fadeInDown">QUANTITY</td>
					...
					if(mysqli_num_rows($result)>0){
                    	...
                    	<tr style="font-size:16px; cursor:pointer;">
                            ...
                            <td class="wow fadeInDown" width="500px"> <center><strong><?php echo $row['description'];?></strong></center></td>
                            ...
                            <td class="wow fadeInDown"> <center><strong><?php echo $row['quantity'];?></strong></center></td>
